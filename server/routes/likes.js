...
router.route('/').post(async (req, res) => {
    ...
    try {
        const newLike = await likesData.createLike(checked_user_id, checked_event_id);
...
router.route('/:userId/:eventId').delete(async (req, res) => {
    ...
    try {
        ...
        if (!ObjectId.isValid(checked_user_id) || !ObjectId.isValid(checked_event_id)) {
    ...
    try {
        const result = await likesData.removeLike(checked_user_id, checked_event_id);
...
router.route('/:userId/:eventId').get(async (req, res) => {
    ...
    try {
        const likeStatus = await likesData.getLikeByUserIdEventId(checked_user_id, checked_event_id);
